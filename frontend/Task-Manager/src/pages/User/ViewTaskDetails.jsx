      ...
      <div className="grid grid-col-1 md:grid-cols-4 mt-4">
          <div className="form-card col-span-3">
            <div className="flex items-center justify-between">
              ...
              <div className={`text-[11px] nd:text-[13px] font-medium ${getStatusTagColor(
                task?.status
              )} px-4 py-0.5 rounded`}
              >
                {task?.status}
...
const TodoCheckList=({text,isChecked,onChange})=>{
  ...
  <div className="flex items-center gap-3 p-3">
    ...
    <p className="text-p[13px] text-gray-800">{text}</p>
  </div>
)}

const Attachment=({link,index,onClick})=>{
  return(
  <div className='flex justify-between bg-gray-50 border border-gray-100 px-3 py-2'
  onClick={onClick}
  >
